          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1 space-y-4">
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-2">
                {/* Visa Logo */}
                <svg className="h-7 w-auto" viewBox="0 0 780 500" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Visa">
                ...
                {/* Mastercard Logo */}
                <svg className="h-7 w-auto" viewBox="0 0 780 500" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Mastercard">
