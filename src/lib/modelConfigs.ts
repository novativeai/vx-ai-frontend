...
export const modelConfigs: { [key: string]: ModelConfig } = {
  ...
  "pixverse-v6": {
    ...
    bannerImage: "/banners/wan-banner.jpg",
    cardVideo: `${WEBSITE_VIDEOS}/pixverse-v6-example.mp4`,
    exampleVideo: `${WEBSITE_VIDEOS}/pixverse-v6-example.mp4`,
  ...
  "ltx-2": {
    ...
    bannerImage: "/banners/wan-banner.jpg",
    cardVideo: `${MARKETPLACE_VIDEOS}/051_Woman_Library.mp4`,
    exampleVideo: `${MARKETPLACE_VIDEOS}/050_Woman_Holding_Mug.mp4`,
  ...
  "hailuo-2.3-pro": {
    ...
    exampleVideo: `${MARKETPLACE_VIDEOS}/049_Woman_Cinematic_On_Bed.mp4`,
